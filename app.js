  ...
  var renderFeed = function (user) {
    if (arguments[0] === undefined) {
      ...
      while (index >= 0) {
        ...
        var $profilePic = $(
          '<img class="profile-photo" src="assets/img/' +
            tweet.user +
            '.png" alt="Picture of ' +
            tweet.user +
            '">'
        ...
        var $commentButton = $(
          '<i class="icon comment fas fa-comment-dots fa-2x"></i>'
        );
        $commentButton.appendTo($tweetDiv);

        var $retweetButton = $(
          '<i class="icon retweet far fa-paper-plane fa-2x" ></i>'
        );
        ...
        var $shareButton = $(
          '<i class="icon share fas fa-share-alt fa-2x" ></i>'
        );
